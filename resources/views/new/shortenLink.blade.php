...
{{--                    <input type="text" name="longURL" id="longURL" class="form-control" placeholder="Enter URL" aria-label="Recipient's username" aria-describedby="basic-addon2" >--}}
{{--                    <div class="input-group-append">--}}
{{--                        <a class="btn btn-success" href="/">Create Short URL</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </form>--}}
{{--        </div>--}}
